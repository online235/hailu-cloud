...
import com.hailu.cloud.api.xinan.module.dao.XaPayExpandMapper;
 ...
 */
@Service
public class XinAnPayExpandService {

    @Resource
    private XaPayExpandMapper xaPayExpandMapper;
    ...
    public PayExpand saveEntity(PayExpand pay){
        ...
        if(StringUtils.isBlank(pay.getId())){
            ...
            xaPayExpandMapper.insert(pay);
            return pay;
        }
        xaPayExpandMapper.updateByPrimaryKeySelective(pay);
        return pay;
    }
    ...
    public PayExpand findById(String id){
        ...
        return xaPayExpandMapper.selectByPrimaryKey(id);
    }
    ...
    public List<PayExpand> findListByPayId(String id){
        return xaPayExpandMapper.findListByPayId(id);
    }
