...
import com.hailu.cloud.api.xinan.module.dao.XaInsuredMapper;
import com.hailu.cloud.api.xinan.module.dao.XaOrderMapper;
import com.hailu.cloud.api.xinan.module.entity.Insured;
import com.hailu.cloud.api.xinan.module.entity.Order;
import com.hailu.cloud.api.xinan.module.enums.MemberShopEnum;
...
@Slf4j
@Service
public class XinAnInsuredService {

    @Resource
    private XaInsuredMapper xaInsuredMapper;
    ...
    public Object addOrEditInsured(String name, String idCard, String memberId, Integer memberRelation, Integer type, Integer isYearEnjoy, String photoUrl) {
        ...
        try {
            ...
            //创建订单
            Order order = xinAnOrderService.buildOrder(insured.getName(), insured.getValue(), memberId, MemberShopEnum.INSURD.getDesc(), "XA", "购买心安", null, money == null ? new BigDecimal(flag ? NEXTMONEY : FIRSTMONEY) : money);
