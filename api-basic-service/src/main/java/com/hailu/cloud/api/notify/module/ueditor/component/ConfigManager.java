package com.hailu.cloud.api.notify.module.ueditor.component;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONException;
import com.alibaba.fastjson.JSONObject;
import com.hailu.cloud.api.notify.module.ueditor.component.define.ActionMap;
...
public final class ConfigManager {
     ...
     */
    private ConfigManager(String rootPath, String contextPath, String uri, String serverPrefix) throws IOException {
        rootPath = rootPath.replace("\\", "/");
        this.rootPath = rootPath;
        this.initEnv(serverPrefix);
    }
     ...
     */
    public static ConfigManager getInstance(String rootPath, String contextPath, String uri, String serverPrefix) {

        try {
            return new ConfigManager(rootPath, contextPath, uri, serverPrefix);
        } catch (Exception e) {
            return null;
        }
    ...
    private void initEnv(String serverPrefix) throws IOException {
        //更改获取配置文件的方式
        ...
        configContent = configContent.replaceAll("\\{none}", serverPrefix);
        try {
