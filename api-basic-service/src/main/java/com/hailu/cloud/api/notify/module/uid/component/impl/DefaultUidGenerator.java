...
import com.hailu.cloud.api.notify.module.uid.component.BitsAllocator;
import com.hailu.cloud.api.notify.module.uid.component.UidGenerator;
import com.hailu.cloud.api.notify.module.uid.component.exception.UidGenerateException;
import com.hailu.cloud.api.notify.module.uid.component.service.IWorkerIdAssignerService;
 ...
 * <p>
 * The {@link DefaultUidGenerator#parseUuid(long)} is a tool method to parse the bits
 *
 * <pre>{@code
 * +------+----------------------+----------------+-----------+
...
public class DefaultUidGenerator implements UidGenerator, InitializingBean {
     ...
     * Spring property
     */
    protected IWorkerIdAssignerService workerIdAssigner;
    ...
    @Override
    public long uuid() throws UidGenerateException {
        try {
            return nextId();
        } catch (Exception e) {
     ...
     */
    public void setWorkerIdAssigner(IWorkerIdAssignerService workerIdAssigner) {
    ...
    public void setEpochStr(String epochStr) {
        if (StringUtils.isNotBlank(epochStr)) {
            ...
            this.epochSeconds = TimeUnit.MILLISECONDS.toSeconds(DateUtil.parse(epochStr).getTime());
        }
    }
}
