...
public class AdminController {
    ...
    @GetMapping("/admins")
    public PageInfoModel<List<SysAdminModel>> refreshToken(
            String nickName,
            String account,
            Integer status,
        ...
        return adminService.accountList(nickName, account, status, Integer.valueOf(pageNum), Integer.valueOf(pageSize));
    }
